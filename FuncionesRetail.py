...
def transformar_variables(x,y=None,modo = 'entrenamiento'):
    ...
    * Haciendo que el parámetro y sea opcional, ya que en ejecución no se usa
    ...
    ruta_proyecto = 'E:/alex/03_MACHINE_LEARNING/CASOS/02_RETAIL'
...
def lanzar_ejecucion(df, modo = 'datos'):
    ...
    for cada in range(0,len(lista_modelos)):
        ...
        if modo == 'datos':
            ...
            #si la predicción va a ser negativa que nos ponga 0
            predicciones['prediccion'] = predicciones.prediccion.apply(lambda x: 0 if x < 0 else x)
